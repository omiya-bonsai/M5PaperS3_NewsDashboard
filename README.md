...
詳細仕様は [`docs/architecture.md`](/Users/tomato/Documents/Arduino/M5PaperS3_NewsDashboard/docs/architecture.md) と [`docs/cache-and-refresh.md`](/Users/tomato/Documents/Arduino/M5PaperS3_NewsDashboard/docs/cache-and-refresh.md) を参照してください。
...
操作判定の詳細は [`docs/touch-gesture.md`](/Users/tomato/Documents/Arduino/M5PaperS3_NewsDashboard/docs/touch-gesture.md) を参照してください。
...
表示まわりの詳細は [`docs/display-ui.md`](/Users/tomato/Documents/Arduino/M5PaperS3_NewsDashboard/docs/display-ui.md) を参照してください。
...
[`config.example.h`](/Users/tomato/Documents/Arduino/M5PaperS3_NewsDashboard/config.example.h) を参考に、同じ内容で `config.h` を作成します。
...
```sh
arduino-cli compile -b m5stack:esp32:m5stack_papers3 /Users/tomato/Documents/Arduino/M5PaperS3_NewsDashboard
```
...
- 電源制御の詳細は [`docs/power-policy.md`](/Users/tomato/Documents/Arduino/M5PaperS3_NewsDashboard/docs/power-policy.md) を参照してください
